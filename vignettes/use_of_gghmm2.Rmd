...
```
To last the user can use the Expectation–maximization algorithm to fit their data to a *HMM*. Here the user need to provide the data and a HMM object, which contain the initial guess for the parameters. The function will return *HMM* obejct, but now with the new parameters. 
```{r}
HM2 = em(HM,X)
HM2
```
